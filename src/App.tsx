        ...
        return <HomeScreen 
          ...
          onNewRecipe={() => {
            ...
            const newRecipe: Recipe = {
              ...
              unit: 'F',
              steps: [
                { id: 'prewash', name: 'Pre-Wash', duration: 60, agitation: { enabled: false, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'Continuous Agitation' },
                { id: 'developer', name: 'Developer', duration: 600, agitation: { enabled: true, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'First Minute - 30s Agitation; Subsequent Minutes - 10s Agitation; Pour Out Developer at Final 10s' },
                { id: 'stop', name: 'Stop Bath', duration: 60, agitation: { enabled: false, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: '30s Agitation; 30s Rest' },
                { id: 'fixer', name: 'Fixer', duration: 300, agitation: { enabled: true, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'First Minute - 30s Agitation; Subsequent Minutes - 10s Agitation' },
                { id: 'wash1', name: 'Wash', duration: 60, agitation: { enabled: false, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'Fill and Dump Tank 3 Times' },
                { id: 'hypo', name: 'Hypo Clear', duration: 120, agitation: { enabled: false, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'Continuous Agitation' },
                { id: 'wash2', name: 'Final Wash', duration: 300, agitation: { enabled: false, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'Clean Paterson Tank with Hot Water Before Wetting Agent' },
                { id: 'wetting', name: 'Wetting Agent', duration: 120, agitation: { enabled: false, initialDuration: 30, interval: 60, duration: 10, alertType: 'both' }, enabled: true, notes: 'Continuous, Slow Agitation' },
